...
foreach ($s in $sizes) {
    ...
    $fontArgs = @('Segoe UI Semibold', $fontSizeSingle, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
    $font = New-Object System.Drawing.Font -ArgumentList $fontArgs
    $text = 'IS'
